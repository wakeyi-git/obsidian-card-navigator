...
export const en = {
	...
	settings: {
		...
		grouping: {
			...
			weekFormat: (year: number, week: number) => `${year} Week ${week}`,
			monthNames: {
				1: 'January',
				2: 'February',
				3: 'March',
		...
		matrix2D: {
			title: '2D Matrix Grouping',
			description: 'Group cards in a 2D matrix layout (e.g., Eisenhower Matrix)',
			enabled: 'Enable 2D Matrix',
			enabledDescription: 'Display cards in a 2D matrix layout based on two property criteria',
			primaryAxis: 'Primary Axis (Horizontal)',
			primaryAxisDescription: 'Property for the horizontal axis',
			secondaryAxis: 'Secondary Axis (Vertical)',
			secondaryAxisDescription: 'Property for the vertical axis',
			propertyName: 'Property Name',
			propertyNamePlaceholder: 'e.g., urgency',
			propertyValues: 'Property Values',
			propertyValuesDescription: 'Comma-separated list of values (in display order)',
			propertyValuesPlaceholder: 'e.g., Urgent, Not Urgent',
			axisLabel: 'Axis Label',
			axisLabelPlaceholder: 'e.g., Urgency',
			showUnclassifiedSection: 'Show Unclassified Section',
			showUnclassifiedSectionDescription: 'Display files without property values in a separate section at the top',
			unclassifiedSectionTitle: 'Unclassified Section Title',
			unclassifiedSectionTitlePlaceholder: 'Unclassified',
			enableDragDropPropertyChange: 'Enable Drag & Drop Property Change',
			enableDragDropPropertyChangeDescription: 'Allow changing file properties by dragging cards to different cells',
			cellMinWidth: 'Cell Minimum Width',
			cellMinWidthDescription: 'Minimum width of each matrix cell (px)',
			cellMinHeight: 'Cell Minimum Height',
			cellMinHeightDescription: 'Minimum height of each matrix cell (px)',
			cardMinWidth: 'Card Minimum Width',
			cardMinWidthDescription: 'Minimum width of cards within matrix cells (px)',
			presets: {
				title: 'Matrix Presets',
				eisenhowerMatrix: 'Eisenhower Matrix',
				eisenhowerDescription: 'Urgent/Not Urgent × Important/Not Important',
				custom: 'Custom Matrix',
			},
			dragDropHint: 'Drag cards to cells to change their properties',
			unclassifiedHint: 'Cards without property values appear here',
			propertyUpdated: (fileName: string, props: string) => `Updated ${fileName}: ${props}`,
	...
	settingsTab: {
		...
		presetSettings: {
			...
			// Apply Scope (Preset Categories)
			applyScopeButton: 'Apply Scope',
			applyScopeTitle: 'Preset Apply Scope',
			applyScopeDescription: 'Select which settings categories to apply when this preset is auto-applied. Unselected categories will keep the current global settings.',
			applyScopeUpdated: 'Preset apply scope updated',
			selectAll: 'Select All',
			deselectAll: 'Deselect All',
			categoryMode: 'Mode',
			categoryModeDesc: 'Folder/Tag mode and mode-specific settings',
			categoryGrouping: 'Grouping',
			categoryGroupingDesc: 'Grouping criteria, group sorting (excludes 2D Matrix)',
			categoryMatrix2D: '2D Matrix',
			categoryMatrix2DDesc: '2D Matrix grouping settings (Eisenhower Matrix, etc.)',
			categoryPin: 'Pin',
			categoryPinDesc: 'Pinned file settings and pin group display',
			categorySort: 'Sort',
			categorySortDesc: 'Card sorting criteria and order',
			categoryCardContent: 'Card Content',
			categoryCardContentDesc: 'Header/Body/Footer content type and render mode',
			categoryCardStyle: 'Card Style',
			categoryCardStyleDesc: 'Card colors, borders, and styles',
			categoryLayout: 'Layout',
			categoryLayoutDesc: 'Card size, spacing, and layout mode',
			categoryInteraction: 'Interaction',
			categoryInteractionDesc: 'Hover actions, click behavior, and drag & drop',
			priorityTypeOptions: {
				folder: 'Folder',
				tag: 'Tag',
				property: 'Property',
