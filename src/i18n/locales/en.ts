...
export const en = {
	...
	settingsTab: {
		...
		layoutSettings: {
			...
			maxWidthDescription: (min: number, max: number) => `Set the maximum width of cards (${min}-${max}px)`,
			maxHeight: 'Card Maximum Height',
			maxHeightDescription: (min: number, max: number) => `Set the maximum height of cards (${min}-${max}px)`,
			cardGap: 'Card Gap',
